    ...
    <div className='max-w-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6'>
      ...
      <div className='rounded-xl relative'>
        ...
        <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
          <p className='font-bold text-2xl px-2 pt-4'>Sunrise Whispers, Dreams Awaken</p>
          <p className='px-2'>Through 8/26</p>
          <button className='order-button'>Order Now</button>
        </div>
        <img
        className='w-full object-cover rounded-xl max-h-[160px] md:max-h-md'
        src='https://images.pexels.com/photos/8230030/pexels-photo-8230030.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'
      alt='/'
/>
      ...
      <div className='rounded-xl relative'>
        ...
        <img
        className='max-h-[70px] md:max-h-[200px] w-full object-cover rounded-xl'
