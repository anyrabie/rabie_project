      ...
      <div>
        <Sheet>
          ...
          <SheetContent>
            ...
            <SheetTitle className="center-justified">
              <Link to="/">
                <Button className="k">Get Start</Button>
              </Link>
            </SheetTitle>
          </SheetContent>
        </Sheet>
        ...
        <Sheet>
          ...
          <SheetContent>
            <SheetHeader>
              <SheetTitle className="ka">
                <img
                  src="https://cdn.pixabay.com/photo/2019/03/12/07/00/clumsy-4050065_960_720.png"
                  alt="Panel One"
                  style={{ width: "80%", height: "50%" }}
                />
              </SheetTitle>
              <SheetTitle className="center">
                The number of items exceeds 6
              </SheetTitle>
              <SheetDescription>
  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 pt-4">
      <Dialog>
        {foods.map((item, index) => (
          ...
          >
            ...
            <div className="flex justify-between px-2 py-4">
              ...
              <p>
                <span className="costum-two">{item.price} Da</span>
              </p>
        ...
        <DialogContent>
          <CartItemDialog selectedItem={selectedItem} addItem={addItem} />
        </DialogContent>
      </Dialog>
    </div>
  );
